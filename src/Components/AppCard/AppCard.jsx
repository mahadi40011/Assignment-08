...
const AppCard = ({app}) => {
  ...
  return (
    <div className='bg-white p-4 object-cover rounded-xl shadow-lg'>
      <div className='mb-5'>
        <img className='w-full h-70 object-cover rounded-xl' src={image} alt={title} />
      </div>
      ...
      <div className='flex justify-between items-center mt-2'>
        <div className='flex items-center justify-center gap-1 rounded-lg p-2 text-green-400 bg-[#F1F5E8] w-fit'>
          ...
          <span className='text-lg font-semibold  '> {downloads/1000000} M</span>
        </div>
