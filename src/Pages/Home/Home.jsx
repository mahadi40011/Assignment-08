    ...
    <div>
      ...
      <div>
        <div className="mt-8 md:mt-14 lg:mt-20 text-center">
          <h1 className="font-bold text-2xl md:text-3xl lg:text-5xl mb-1 md:mb-2 lg:mb-4">
            Trending Apps
          </h1>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 my-10 px-2  md:px-0">
          {trendingApp.map((app) => (
